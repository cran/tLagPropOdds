...
#'     \item{delta:}{The clinical event indicator (1 if U is the event time;
#'                   0 otherwise).}
...
#'
#' @returns An S3 object of class tLagObj containing a list. The
...
#'
#' @include verifyInputs.R ipw.R aipw.R
#'
#' @export
#'
#' @examples
